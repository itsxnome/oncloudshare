...
**Current version:** [`1.2.2`](https://github.com/itsxnome/oncloudshare/releases/tag/v1.2.2) (Electron + React · iOS AltStore)
...
| `OnCloudShare-1.2.2.ipa` | iOS app for **AltStore** |
