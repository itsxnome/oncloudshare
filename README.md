...
**Current version:** [`1.3.2`](https://github.com/itsxnome/oncloudshare/releases/tag/v1.3.2) (Electron + React · iOS AltStore)
...
| `OnCloudShare-1.3.2.ipa` | iOS app for **AltStore** |
...
- Hide / Show the **You’re hosting** panel (more room for messages)

## What’s new in 1.3.1

- Fixed IPA build so in-app update check works again

## What’s new in 1.3.0

- **Copy** text from room items
- **Save** images/videos to Photos · **Download** / **Share** any file
- **Paste** clipboard (text or image)
- **Drop** files onto the room (iPad)

## What’s new in 1.2.9

- Tap outside a field (or scroll) to dismiss the keyboard
- Keyboard **Done** button for PIN / number pads
...
- Show / Hide QR on the iPhone host screen
- Browser file downloads over WebSocket (fixes loca.lt **Bad Gateway** on `/files/...`)
...
- Fix room dying when switching to WhatsApp (keep-alive + auto-recover)
- Avoid double public-tunnel start
...
- **iOS public rooms** — temporary internet join link (loca.lt) + QR code
- Copy / regenerate public link; LAN hosting still available
